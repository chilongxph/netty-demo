				...
				try {
					...
					for (Iterator<SelectionKey> it = ops.iterator(); it.hasNext();) {
						...
						if (key.isConnectable()) {
							System.out.println("client connect---"+System.currentTimeMillis());
							...
							System.out.println("-----connectable------"+System.currentTimeMillis());
							sc.register(selector, SelectionKey.OP_READ);
						} else if (key.isWritable()) {
							System.out.println("客户端写----"+System.currentTimeMillis());
							SocketChannel sc = (SocketChannel) key.channel();
							ByteBuffer buffer = ByteBuffer.allocate(1024);
							buffer.put("hello server.".getBytes());
							buffer.flip();
							...
							System.out.println("客户端收到服务器的响应...."+System.currentTimeMillis());
							SocketChannel sc = (SocketChannel) key.channel();
							ByteBuffer buffer = ByteBuffer.allocate(1024);
